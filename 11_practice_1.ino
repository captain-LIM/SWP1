...
#define _DUTY_NEU 1847 // servo neutral position (90 degree)
#define _DUTY_MAX 2399 // servo full counterclockwise position (180 degree)

// global variables
float timeout; // unit: us
float dist_min, dist_max, dist_raw, dist_prev,dist_ema, alpha,dist_mid; // unit: mm
...
// get a distance reading from the USS
  ...
  dist_mid = _DUTY_MIN+(_DUTY_NEU/181)*(dist_raw-180);
...
// adjust servo position according to the USS read value
  ...
  if(dist_raw<180) {
    ...
    myservo.writeMicroseconds(_DUTY_MIN);
     ...
     myservo.writeMicroseconds( dist_mid);
